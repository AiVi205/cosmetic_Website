                ...
                <div class="card-body">
                    ...
                    <form method="post" action="add-product.php" enctype="multipart/form-data">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="ma_san_pham" id="product-code" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="product-name" class="col-sm-2 col-form-label">Tên sản phẩm</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="ten_san_pham" id="product-name" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="brand" class="col-sm-2 col-form-label">Mô tả sản phẩm</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="mo_ta" id="mo_ta" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="brand" class="col-sm-2 col-form-label">Thương hiệu</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="thuong_hieu" id="brand" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="so_luong" id="quantity" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="product-image" class="col-sm-2 col-form-label">Ảnh minh họa</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="file" id="product-image" name="anhmh" accept="image/*"
                                    required>
                            </div>
                        </div>
