        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="bg-light p-30 mb-3">
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>266 Đội Cấn, Liễu Giai, Hà Nội</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>admin@gmail.com.vn</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>0338 827 004</p>
                </div>
            </div>
        </div>
    </div>
